        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8"><h2>2376 <i class="font-14 text-danger"></i></h2>
                                    <h6>Total LCDs</h6></div>
                                <div class="col-4 align-self-center text-right  p-l-0">
                                    <div class="stat-ic text-info"><i class="ti-desktop"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <!-- Row -->
                            <div class="row">
                                <div class="col-8"><h2 class="">36<i class="font-14 text-success"></i></h2>
                                    <h6>Total Images</h6></div>
                                <div class="col-4 align-self-center text-right p-l-0">
                                    <div class="stat-ic text-success"><i class="ti-image"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <!-- Row -->
                            <div class="row">
                                <div class="col-8"><h2>152 <i class="font-14 text-success"></i></h2>
                                    <h6>Total Videos</h6></div>
                                <div class="col-4 align-self-center text-right p-l-0">
                                    <div class="stat-ic text-purple"><i class="ti-video-camera"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-8"><h2>35<i class="font-14 text-danger"></i></h2>
                                    <h6>Ads Created</h6></div>
                                <div class="col-4 align-self-center text-right p-l-0">
                                    <div class="stat-ic text-warning"><i class="ti-layers"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row el-element-overlay">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="el-card-item">
                            <div class="el-card-avatar el-overlay-1"><img src="{{asset('asset/img/templates/temp-03.png')}}" alt="user" />
                                <div class="el-overlay">
                                    <ul class="el-info">
                                ...
                                <div class="row paddingzero">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-7">
                                        <div class="row">
                                            <div class="video-box">
                                                <figure>
                                                    <img src="{{asset('asset/img/video-img.jpg')}}" alt="image description">
                                                </figure>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row paddingzero">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="row">
                                            <div class="img-box">
                                                <figure>
                                                    <img src="{{asset('asset/img/popup-img1.jpg')}}" alt="image description">
                                                </figure>
                                                <div class="price-box">
                                                    <h3>$<sub>500</sub></h3>
                                                </div>
                                            ...
                                            <div class="modalcontent-box">
                                                <div class="modalcontent-boxholder">
                                                    <div class="text-box">
                                                        ...
                                                        <span class="date">dated: 05-06-2018</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="modal-body">
                            <div class="modal-contentarea">
                                <div class="tg-modalbox">
                                    <div class="modalcontent-box">
                                        <span class="tg-date">dated: 05-06-2018</span>
                                        <div class="text-box">
                                            <h2>LOREM IPSUM DE UTENIUM DOLROE</h2>
                                            <span class="price-box"><h3>$<sub>500</sub></h3></span>
